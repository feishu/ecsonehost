...
public class SmartTagToolsModule extends WXModule implements CPCallback
{
    ...
    static class SmartTagFactory implements ScannerCallback
    {
        ...
        private void stopScan(String str){
            if(insigmaBluetoothManager!=null && _scanState == 1){
