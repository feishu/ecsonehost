...
public class zoomImageView extends PhotoView implements WXGestureObservable,
        IRenderStatus<zoomImage> {

  private WeakReference<zoomImage> mWeakReference;
  ...
  public void setImageDrawable(@Nullable Drawable drawable, boolean isGif) {
    ...
    if ((layoutParams = getLayoutParams()) != null) {
      ...
      if (mWeakReference != null) {
        zoomImage component = mWeakReference.get();
        if (component != null) {
  ...
  @Override
  public void holdComponent(zoomImage component) {
