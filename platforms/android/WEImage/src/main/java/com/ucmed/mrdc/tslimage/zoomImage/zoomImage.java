 ...
 */
package com.ucmed.mrdc.tslimage.zoomImage;
...
public class zoomImage extends WXComponent<PhotoView> {

  public static class Creator implements ComponentCreator {
    @Override
    public WXComponent createInstance(WXSDKInstance instance, WXVContainer parent, BasicComponentData basicComponentData) throws IllegalAccessException, InvocationTargetException, InstantiationException {
      if(!basicComponentData.getAttrs().containsKey("src")){
        if(basicComponentData.getAttrs().containsKey("placeHolder")){
          basicComponentData.getAttrs().put("src",basicComponentData.getAttrs().get("placeHolder").toString());
        }
      }
      return new zoomImage(instance, parent, basicComponentData);
    }
  }

  @Deprecated
  public zoomImage(WXSDKInstance instance, WXVContainer parent, String instanceId, boolean isLazy, BasicComponentData basicComponentData) {
    this(instance, parent, basicComponentData);
  }

  public zoomImage(WXSDKInstance instance, WXVContainer parent, BasicComponentData basicComponentData) {
    super(instance, parent, basicComponentData);
  }

  @Override
  protected PhotoView initComponentHostView(@NonNull Context context) {
  ...
  public void refreshData(WXComponent component) {
    ...
    if (component instanceof zoomImage) {
  ...
  private void setRemoteSrc(Uri rewrited) {
      ...
      imageStrategy.blurRadius = (int)getStyles().getBorderRadius();
    ...
    imageStrategy.setImageListener(new WXImageStrategy.ImageListener() {
      ...
      if (getAttrs().containsKey(Constants.Name.PLACE_HOLDER)) {
        String attr = (String) getAttrs().get(Constants.Name.PLACE_HOLDER);
  ...
  public void updateBorderRadius() {
    ...
    if (getHostView() instanceof zoomImageView) {
      imageView = (zoomImageView) getHostView();
