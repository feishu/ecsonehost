package com.ucmed.mrdc.tslimage.imagepicker.ui;
...
import com.ucmed.mrdc.tslimage.imagepicker.DataHolder;
import com.ucmed.mrdc.tslimage.imagepicker.ImageDataSource;
import com.ucmed.mrdc.tslimage.imagepicker.ImagePicker;
import com.ucmed.mrdc.tslimage.imagepicker.adapter.ImageFolderAdapter;
import com.ucmed.mrdc.tslimage.imagepicker.adapter.ImageRecyclerAdapter;
import com.ucmed.mrdc.tslimage.imagepicker.bean.ImageFolder;
import com.ucmed.mrdc.tslimage.imagepicker.bean.ImageItem;
import com.ucmed.mrdc.tslimage.imagepicker.view.FolderPopUpWindow;
import com.ucmed.mrdc.tslimage.imagepicker.weex_module.ImageSelector;
import com.ucmed.mrdc.tslimage.util.CompressTask;
...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
    ...
    private List<String> getImagePaths(ArrayList<ImageItem> list){
    ...
    private void compressImage(List<String> images){
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            if(imagePicker.getCompress()<1&&imagePicker.getSelectedImages().size()>0){
                String[] strings = new String[imagePicker.getSelectedImages().size()];
                new CompressTask(this).execute((String[])getImagePaths(imagePicker.getSelectedImages()).toArray(strings));
            }else {
                ImageSelector.getInstance().selectComplete(getImagePaths(imagePicker.getSelectedImages()));//传给weex-module
                finish();
            }
            ...
            //点击返回按钮
            ImageSelector.getInstance().selectComplete(null);
            finish();
        }
    }
            ...
            if (resultCode == ImagePicker.RESULT_CODE_BACK) {
                ...
                if (data.getSerializableExtra(ImagePicker.EXTRA_RESULT_ITEMS) == null) {
                    ...
                    if(imagePicker.getCompress()<1&&imagePicker.getSelectedImages().size()>0){
                        ...
                        ImageSelector.getInstance().selectComplete(getImagePaths((ArrayList<ImageItem>) data.getSerializableExtra(ImagePicker.EXTRA_RESULT_ITEMS)));
...
//                }
                ...
                ImageSelector.getInstance().selectComplete(null);//传给weex-module
                finish();
            }
        }
    }
