...
public interface Promise {
   ...
   */
  void reject(Throwable throwable, HashMap userInfo);
   ...
   * @param userInfo WritableMap
   */
  void reject(String code, @NonNull HashMap userInfo);
   ...
   * @param userInfo WritableMap
   */
  void reject(String code, Throwable throwable, HashMap userInfo);
   ...
   * @param userInfo WritableMap
   */
  void reject(String code, String message, @NonNull HashMap userInfo);
   ...
   * @param userInfo WritableMap
   */
  void reject(String code, String message, Throwable throwable, HashMap userInfo);
