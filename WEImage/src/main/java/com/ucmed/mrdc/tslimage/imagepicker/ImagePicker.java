...
import com.ucmed.mrdc.tslimage.imagepicker.util.ProviderUtil;
...
public class ImagePicker {
    ...
    public static final String ONLY_PERVIEW = "ONLY_PERVIEW";
...
//            cropCacheFolder = new File(Environment.getExternalStorageDirectory() + "/ImagePicker/cropTemp/");
        }
