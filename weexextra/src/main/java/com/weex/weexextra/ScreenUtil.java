...
//        EGL10 egl = (EGL10) EGLContext.getEGL();
    ...
    private static void init(Activity activity) {
        DisplayMetrics packageMetrics = activity.getResources().getDisplayMetrics();
        int desiredWindowHeight = packageMetrics.heightPixels;
        int statusBarHeight = getBarHeight(activity);
        NoBarHeight = desiredWindowHeight - statusBarHeight;
...
//        pixelRatio =  (double)DisplayWidth / 750.0D;
...
//        }
    ...
    private static void hasSoftKeys(WindowManager windowManager){
        ...
        showSoftKeys = (realWidth - displayWidth) > 0 || (realHeight - displayHeight) > 0;
        }
    }
